...
def merge_SRCID(src):
    ...
    matches_end = start_at_hour.reindex(index = (end_at_hour.index + end_at_hour["len"] + dt.timedelta(seconds=1)))
    ...
    matches_start = end_at_hour.reindex(index = (end_at_hour.index + end_at_hour["len"] + 
                    dt.timedelta(seconds=1)).isin(start_at_hour.index))
